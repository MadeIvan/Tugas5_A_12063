...
model_directory = r"D:\SEMESTER 5\Machine Learning\Tugas5_A_12063"
...
if os.path.exists(model_path):
    try:
        ...
        def preprocess_image(image):
            ...
            image_array = image_array.reshape(-1)  # Flatten ke bentuk 1D array
            return image_array

        # UI Streamlit
        st.title("Fashion MNIST Image Classifier - 2063") # 4 digit npm
        st.write("Unggah beberapa gambar item fashion (misalnya sepatu, tas, baju), dan model akan memprediksi kelas masing-masing.")

        # File uploader untuk mengunggah gambar (multiple files)
        ...
        with st.sidebar:
            st.write(":triangular_flag_on_post: Navigator")
